...
from attack.BFA_bin import *
from attack.BFA_quan import *
import attack.BFA_bin as BFA_bin
import attack.BFA_quan as BFA_quan
...
parser.add_argument('--resume',
                    # default='save/2023-09-07/cifar10_resnet20_quan_SGD_QAT_4bit/model_best.pth.tar',
                    type=str,
                    metavar='PATH',
...
def main():
    ...
    if args.bin:
        attacker = BFA_bin.BFA(criterion, net, args.k_top)
    else:
        attacker = BFA_quan.BFA(criterion,args.k_top)
