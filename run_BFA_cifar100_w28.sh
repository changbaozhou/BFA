...
#     )
checkpoints=(
    wideresnet28_cifar100_SGD
    wideresnet28_cifar100_SAM_rho0.05
    wideresnet28_cifar100_SAM_rho0.1
    wideresnet28_cifar100_SAM_rho0.25
    wideresnet28_cifar100_SAM_rho0.5
    wideresnet28_cifar100_SAM_rho0.8
    wideresnet28_cifar100_SAM_rho1.0
    )
...
do
    ...
    for seed in "${seeds[@]}"
    do
        echo "Executing BFA_cifar100.sh $model on $checkpoint with parameter: $seed"
        bash BFA_cifar100.sh "$model" "$seed"  "$checkpoint"
    done
done
