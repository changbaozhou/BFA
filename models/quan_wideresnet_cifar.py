...
class BasicBlock(nn.Module):
    def __init__(self, in_planes, out_planes, stride, dropRate=0.0):
        ...
        self.conv1 = quan_Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(out_planes)
        self.relu2 = nn.ReLU(inplace=True)
        self.conv2 = quan_Conv2d(out_planes, out_planes, kernel_size=3, stride=1,
                               padding=1, bias=False)
...
class WideResNet(nn.Module):
    def __init__(self, depth=34, num_classes=10, widen_factor=10, dropRate=0.0):
        ...
        self.conv1 = quan_Conv2d(3, nChannels[0], kernel_size=3, stride=1,
                               padding=1, bias=False)
        # 1st block
        ...
        self.fc = quan_Linear(nChannels[3], num_classes)
...
def wideresnet28_quan(num_classes=10):
    return WideResNet(depth=28, num_classes=num_classes)


def wideresnet34_quan(num_classes=10):
