    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        if stride != 1 or in_planes != self.expansion*planes:
            self.shortcut = nn.Sequential(
                quan_Conv2d(in_planes, self.expansion*planes, kernel_size=1, stride=stride, bias=False)
            )
...
class PreActBottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn1 = nn.BatchNorm2d(in_planes)
        self.conv1 = quan_Conv2d(in_planes, planes, kernel_size=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv2 = quan_Conv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn3 = nn.BatchNorm2d(planes)
        self.conv3 = quan_Conv2d(planes, self.expansion*planes, kernel_size=1, bias=False)
...
def preactresnet18_quan(num_classes=10):
